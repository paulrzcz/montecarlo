...
/**
 * PathGenerator constructs random paths that satisfy stochastic process.
 * 
 */
public class PathGenerator {
     ...
     */
    public PathGenerator(GenericProcess process, int timeSteps,
    ...
    public Path next() throws FunctionEvaluationException {
        ...
        for (int i = 1; i < timeSteps; ++i) {
            double dw = generator.nextNormalizedDouble();
